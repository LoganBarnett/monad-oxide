...
*** promises/futures
:PROPERTIES:
:CUSTOM_ID: examples--result--promises/futures
:END:

If you are using [[https://github.com/ruby-concurrency/concurrent-ruby][conccurent-ruby]], ~monad-oxide~ supplies a helper you can use to
...
#+begin_src ruby :results output :exports code
require 'monad-oxide'
